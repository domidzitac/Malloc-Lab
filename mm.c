...
//global variable
static char *heap_ptr; //a pointer to 1st block
...
int mm_init(void)
{
    ...
    PUT(heap_ptr+DSIZE, PACK(OVERHEAD, 1));  /* prologue footer */
    PUT(heap_ptr+WSIZE+DSIZE, PACK(0, 1));   /* epilogue header */
    heap_ptr += DSIZE;
